...
export const categories = [
    ...
    },
    {
        label: 'Castles',
        icon: GiCastle,
        description: 'This property is located in a castle'
    },
    {
        label: 'Camping',
        icon: GiForestCamp,
    ...
    },
    {
        label: 'Arctic',
        icon: BsSnow,
        description: 'This property is located in the arctic region'
    },
    {
        label: 'Cave',
        icon: GiCaveEntrance,
        description: 'This property has a cave entrance'
    },
    {
        label: 'Desert',
        icon: GiCactus,
    ...
    },
    {
        label: 'Lux',
        icon: IoDiamond,
        description: 'This property comprises of pure luxury'
    },
